...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('categories', [
      ...
      { id: uuidv4(), slug: 'ban-trang-diem', category: 'Bàn trang điểm', created_at: new Date(), updated_at: new Date() },
      { id: uuidv4(), slug: 'ghe-an', category: 'Ghế ăn', created_at: new Date(), updated_at: new Date() },
      { id: uuidv4(), slug: 'ghe-lam-viec', category: 'Ghế làm việc', created_at: new Date(), updated_at: new Date() },
      ...
      { id: uuidv4(), slug: 'sofa', category: 'Sofa', created_at: new Date(), updated_at: new Date() },
